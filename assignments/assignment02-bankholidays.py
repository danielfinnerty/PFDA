...
for event in nirl_data['events']:
    if event['date'].startswith('2025'): # Startswith reference: https://www.w3schools.com/python/ref_string_startswith.asp
        print(f'{event["title"]} occurs on {event["date"]}')

print('\n''Northern Ireland 2026 Bank Holidays:')

for event in nirl_data['events']:
    if event['date'].startswith('2026'): # Startswith reference: https://www.w3schools.com/python/ref_string_startswith.asp
        print(f'{event["title"]} occurs on {event["date"]}')

print('\n''Northern Ireland 2027 Bank Holidays:')

for event in nirl_data['events']:
    if event['date'].startswith('2027'): # Startswith reference: https://www.w3schools.com/python/ref_string_startswith.asp
        print(f'{event["title"]} occurs on {event["date"]}')